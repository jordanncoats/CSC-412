...
int main()
{
    ...
    struct cat cats;
    cats.count = 2;
    strcpy(cats.type[0].name, "letters");
    cats.type[0].index = 0;
    cats.type[0].rangeCount = 2;
    cats.type[0].startRange[0] = 'A';
    cats.type[0].endRange[0] = 'Z';
    cats.type[0].startRange[1] = 'a';
    cats.type[0].endRange[1] = 'z';
    strcpy(cats.type[1].name, "numbers");
    cats.type[1].index = 1;
    cats.type[1].rangeCount = 1;
    cats.type[1].startRange[0] = '0';
    cats.type[1].endRange[0] = '9';

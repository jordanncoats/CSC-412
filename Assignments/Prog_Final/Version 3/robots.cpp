...
void move(RobotThread *rt)
{
    ...
    case NORTH:
        ...
        pthread_mutex_lock(&rt->robot_scene->grid_mutex[rt->owner->robot_Row - 1][rt->owner->robot_Col]);
        rt->robot_scene->grid[rt->owner->robot_Row][rt->owner->robot_Col] = 0;

        pthread_mutex_unlock(&rt->robot_scene->grid_mutex[rt->owner->robot_Row][rt->owner->robot_Col]);
        rt->robot_scene->grid[rt->owner->robot_Row--][rt->owner->robot_Col] = 1;
    ...
    case WEST:
        ...
        pthread_mutex_lock(&rt->robot_scene->grid_mutex[rt->owner->robot_Row][rt->owner->robot_Col - 1]);
        rt->robot_scene->grid[rt->owner->robot_Row][rt->owner->robot_Col] = 0;
...
void push(RobotThread *rt)
{
    ...
    if (rt->owner->rowDistanceFromDoor != 0)
    {
        ...
        if (rt->owner->rowDistanceFromDoor < 0)
        {
            ...
            /** Move Box */
            pthread_mutex_lock(&rt->robot_scene->grid_mutex[rt->owner->box_Row - 1][rt->owner->box_Col]);
            rt->robot_scene->grid[rt->owner->box_Row][rt->owner->box_Col] = 0;
            pthread_mutex_unlock(&rt->robot_scene->grid_mutex[rt->owner->box_Row][rt->owner->box_Col]);
            rt->robot_scene->grid[rt->owner->box_Row--][rt->owner->box_Col] = 1;
            /** Move Robot */
            pthread_mutex_lock(&rt->robot_scene->grid_mutex[rt->owner->robot_Row - 1][rt->owner->robot_Col]);
            rt->robot_scene->grid[rt->owner->robot_Row][rt->owner->robot_Col] = 0;
            pthread_mutex_unlock(&rt->robot_scene->grid_mutex[rt->owner->robot_Row][rt->owner->robot_Col]);
    ...
    if (rt->owner->rowDistanceFromDoor == 0 && rt->owner->colDistanceFromDoor != 0)
    {
        ...
        else if (rt->owner->colDistanceFromDoor > 0)
        {
            ...
            pthread_mutex_lock(&rt->robot_scene->grid_mutex[rt->owner->box_Row][rt->owner->box_Col + 1]);
            rt->robot_scene->grid[rt->owner->box_Row][rt->owner->box_Col] = 0;
            pthread_mutex_unlock(&rt->robot_scene->grid_mutex[rt->owner->box_Row][rt->owner->box_Col]);
            rt->robot_scene->grid[rt->owner->box_Row][rt->owner->box_Col++] = 1;
